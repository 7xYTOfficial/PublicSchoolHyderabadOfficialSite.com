    ...
    <header class="text-gray-400 bg-gray-900 body-font">
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          <a class="flex title-font font-medium items-center text-white mb-4 md:mb-0">
            ...
            <span class="ml-3 text-xl">Public School Hyderabad </span>
          </a>
          <nav class="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
            <a href="Main.html" class="mr-5 hover:text-white">Main Page</a>
            <a href="bro.html" class="mr-5 hover:text-white">Home</a>
            <a href="history.html" class="mr-5 hover:text-white">History</a>
            <a href="admmision.html" class="mr-5 hover:text-white">Addmissions</a>
            <a href="about.html" class="mr-5 hover:text-white">About Us</a>
          </nav>
            <button onclick="doSomething()" style="background-color:#111827;color:#a46cff;border:15px">Sign Up</button>
          </a>
      ...
      <div class="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-12 lg:text-left text-center">
        <div class="flex flex-col mb-10 lg:items-start items-center">
          <div class="w-12 h-12 inline-flex items-center justify-center rounded-full bg-gray-800 text-purple-400 mb-5">
            <svg class="svg-icon" viewBox="1 1 21 19" fill="#AC62C7" height="39" viewBox="0 4 32 30" width="39" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="flex-grow">
            ...
            <p class="leading-relaxed text-base">To Get In Touch With Us Click The Button Below!</p>
            <a href="contact.html" class="mt-3 text-purple-400 inline-flex items-center">Click To Find Out!
